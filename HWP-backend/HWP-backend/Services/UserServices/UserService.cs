...
namespace HWP_backend.Services.UserServices
{
    public class UserService
    {
        ...
        public IEnumerable<Task> UnsolvedTasks(int userId)
        {
            var tasks = _context.Tasks
                .Include(t => t.SolvedTasks)
                .Where(x => x.SolvedTasks
                    .All(task => task.UserId != userId));
            return tasks;
        }
    }
}